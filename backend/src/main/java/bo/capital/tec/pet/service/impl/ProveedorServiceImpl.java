...
import bo.capital.tec.pet.repository.DireccionMapper;
...
import bo.capital.tec.pet.domain.Proveedor;
import bo.capital.tec.pet.domain.ProveedorEspecialidad;
import bo.capital.tec.pet.domain.Disponibilidad;
import bo.capital.tec.pet.repository.DisponibilidadMapper;
import bo.capital.tec.pet.repository.ProveedorEspecialidadMapper;
import bo.capital.tec.pet.repository.ProveedorMapper;
...
import bo.capital.tec.pet.repository.RolMapper;
...
import bo.capital.tec.pet.repository.UsuarioRolMapper;
...
public class ProveedorServiceImpl implements ProveedorService {
    ...
    private ProveedorResponseDTO toResponseDTO(Proveedor proveedor) {
        ...
        List<bo.capital.tec.pet.domain.Disponibilidad> dispList = disponibilidadMapper.selectByProveedorYServicio(proveedor.getId(), null);
        List<ProveedorResponseDTO.DisponibilidadDTO> dispDTOs = new ArrayList<>();
        for (bo.capital.tec.pet.domain.Disponibilidad d : dispList) {
