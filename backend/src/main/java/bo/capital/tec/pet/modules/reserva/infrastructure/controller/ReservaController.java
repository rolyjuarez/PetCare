package bo.capital.tec.pet.modules.reserva.infrastructure.controller;
...
public class ReservaController {
    ...
    @PutMapping("/{id}/asignar-proveedor/{proveedorId}")
    @Operation(summary = "Asignar proveedor a reserva")
    public ResponseEntity<ApiResponse<ReservaResponseDTO>> asignarProveedor(
            @PathVariable Long id, @PathVariable Long proveedorId) {
        return ResponseEntity.ok(ApiResponse.success(reservaService.asignarProveedor(id, proveedorId), "Proveedor asignado"));
    }
}
