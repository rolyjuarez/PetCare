package bo.capital.tec.pet.modules.cliente.controller;
...
import bo.capital.tec.pet.modules.cliente.service.ClienteService;
...
public class ClienteController {
    ...
    public ResponseEntity<ApiResponse<ClienteResponseDTO>> getMe() {
        ...
        bo.capital.tec.pet.modules.cliente.entity.Cliente cliente = clienteApi.findByPersonaId(usuario.getPersonaId());
        if (cliente == null) {
