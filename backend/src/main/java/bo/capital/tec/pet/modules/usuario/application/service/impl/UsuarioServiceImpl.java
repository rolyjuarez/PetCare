package bo.capital.tec.pet.modules.usuario.application.service.impl;
...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    public UsuarioResponseDTO create(UsuarioRequestDTO dto) {
        Persona persona = personaApi.selectById(dto.getPersonaId());
        if (persona == null) {
    ...
    public PagedResponse<UsuarioSummaryDTO> getAll(String username, Long personaId, Long rolId, boolean activo, int page, int size) {
        ...
        List<Usuario> usuarios = usuarioRepository.selectAll(username, null, offset, size);
        long total = usuarioRepository.countAll(username, null);
        List<UsuarioSummaryDTO> content = usuarios.stream()
                .map(u -> {
                    Persona persona = personaApi.selectById(u.getPersonaId());
    ...
    private UsuarioResponseDTO toResponseDTO(Usuario usuario, Persona persona) {
        List<String> roles = usuarioRepository.findRolesByUsuarioId(usuario.getId());
