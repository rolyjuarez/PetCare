package bo.capital.tec.pet.modules.sucursal.application.service.impl;
...
import bo.capital.tec.pet.modules.sucursal.domain.port.SucursalRepository;
import bo.capital.tec.pet.modules.sucursal.application.service.SucursalService;
...
public class SucursalServiceImpl implements SucursalService {
    ...
    public SucursalResponseDTO getById(Long id) {
        Sucursal sucursal = sucursalRepository.selectById(id);
        if (sucursal == null) {
    ...
    public PagedResponse<SucursalSummaryDTO> getAll(String nombre, boolean activo, int page, int size) {
        ...
        List<Sucursal> sucursales = sucursalRepository.selectAll(nombre, offset, size);
        long total = sucursalRepository.countAll(nombre);
    ...
    public List<SucursalSummaryDTO> getActive() {
        List<Sucursal> sucursales = sucursalRepository.selectActive();
    ...
    public void delete(Long id) {
        ...
        sucursalRepository.softDelete(id);
    }
