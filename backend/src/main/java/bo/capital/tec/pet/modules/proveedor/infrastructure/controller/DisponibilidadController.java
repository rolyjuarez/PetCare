package bo.capital.tec.pet.modules.proveedor.infrastructure.controller;
...
public class DisponibilidadController {
    ...
    @Operation(summary = "Obtener disponibilidades por servicio (todos los proveedores)")
    public ResponseEntity<ApiResponse<List<DisponibilidadResponseDTO>>> getByServicio(@PathVariable Long servicioId) {
