package bo.capital.tec.pet.rol.service.impl;
...
import bo.capital.tec.pet.rol.service.RolService;
...
public class RolServiceImpl implements RolService {
    ...
    public RolResponseDTO create(RolRequestDTO dto) {
        Rol existing = rolMapper.selectByNombre(dto.getNombre());
        if (existing != null) {
    ...
    public RolResponseDTO getById(Long id) {
        Rol rol = rolMapper.selectById(id);
        if (rol == null) {
    ...
    public RolResponseDTO getByName(String nombre) {
        Rol rol = rolMapper.selectByNombre(nombre);
        if (rol == null) {
    ...
    public PagedResponse<RolSummaryDTO> getAll(String nombre, boolean activo, int page, int size) {
        ...
        List<Rol> roles = rolMapper.selectAll(offset, size);
        long total = rolMapper.countAll();
