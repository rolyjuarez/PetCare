package bo.capital.tec.pet.modules.servicio.application.service.impl;
...
public class ServicioServiceImpl implements ServicioService {
    ...
    public ServicioResponseDTO getById(Long id) {
        Servicio servicio = servicioRepository.selectById(id);
        if (servicio == null) {
    ...
    public PagedResponse<ServicioSummaryDTO> getAll(String nombre, Long categoriaId, boolean activo, int page, int size) {
        ...
        List<Servicio> servicios = servicioRepository.selectAll(nombre, null, offset, size);
        long total = servicioRepository.countAll(nombre, null);
    ...
    public List<ServicioSummaryDTO> getActive() {
        List<Servicio> servicios = servicioRepository.selectActive();
