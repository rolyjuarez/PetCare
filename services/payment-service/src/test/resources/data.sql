...
INSERT INTO reserva (id, codigo, cliente_id, proveedor_id, servicio_id, mascota_id,
    ...
    (3, 'RES-00000003', 1, 1, 2, 1, 2, 'EN_ESTABLECIMIENTO', DATEADD('DAY', 2, CURRENT_DATE), TIME '12:00:00', 100.00);
...
INSERT INTO proveedor_servicio (id, proveedor_id, nombre, categoria, duracion_minutos, precio_base) VALUES
    ...
    (2, 1, 'Peluquería Premium', 'PELUQUERIA', 90, 120.00);

INSERT INTO proveedor_servicio_modalidad (proveedor_servicio_id, modalidad, costo_adicional) VALUES
    (1, 'DOMICILIO', 20.00),
    (1, 'EN_ESTABLECIMIENTO', 0.00);

INSERT INTO promocion (id, proveedor_id, servicio_id, codigo, nombre, tipo_descuento, valor_descuento,
    fecha_inicio, fecha_fin, activa, limite_usos, usos_actuales) VALUES
    (1, 1, 1, 'PROMO-10', 'Promo 10%', 'PERCENTAGE', 10.00,
     DATEADD('DAY', -1, CURRENT_TIMESTAMP), DATEADD('DAY', 30, CURRENT_TIMESTAMP), TRUE, 100, 0),
    (2, 1, 2, 'PROMO-20', 'Promo otro servicio', 'FIXED', 20.00,
     DATEADD('DAY', -1, CURRENT_TIMESTAMP), DATEADD('DAY', 30, CURRENT_TIMESTAMP), TRUE, 50, 0);
